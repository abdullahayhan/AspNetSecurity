...
namespace DataProtection.Security.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(SecurityDbContext context, 
        ...
        public async Task<IActionResult> Index()
        {
            ...
            products.ForEach(x =>
            {
              ...
              return _context.Products != null ? 
                          View(products) :
                          Problem("Entity set 'SecurityDbContext.Products'  is null.");
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            int decrytedId = int.Parse(timeLimitedProtector.Unprotect(id));

            var product = await _context.Products
                .FirstOrDefaultAsync(m => m.Id == decrytedId);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SecurityDbContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
